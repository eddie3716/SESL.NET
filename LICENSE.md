SESL.NET is intended to be used in both open-source and commercial environments. To allow its use in as many
situations as possible, SESL.NET is dual-licensed. You may choose to use SESL.NET under either the Apache License,
